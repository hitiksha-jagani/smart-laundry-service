...
// Description : Service provider profile detail for admin dashboard.
...
const ServiceProviderTablePage = () => {
        ...
        <AdminDashboardLayout user={user}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flex: 1, paddingRight: '260px', marginBottom: '50px' }}>
                    ...
                    <h2 className="h2-admin">SERVICE PROVIDER DATA</h2>
...
export default ServiceProviderTablePage;