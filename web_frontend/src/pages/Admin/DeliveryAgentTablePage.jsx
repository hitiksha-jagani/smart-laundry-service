...
// Description : Delivery agent profile detail for admin dashboard.
...
import DeliveryAgentTableMoreDetailPage from './DeliveryAgentTableMoreDetailPage.jsx';

const DeliveryAgentTablePage = () => {
        ...
        <AdminDashboardLayout user={user}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flex: 1, paddingRight: '260px', marginBottom: '50px' }}>
                    ...
                    <h2 className="h2-admin">DELIVERY AGENT DATA</h2>
...
export default DeliveryAgentTablePage;