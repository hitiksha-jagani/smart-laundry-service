...
// Description : Delivery agent revenue list for admin dashboard.
        ...
        const fetchAllData = async () => {
            ...
            try {
                ...
                const [userRes, tableRes] = await Promise.all([
                    ...
                    axiosInstance.get("/revenue/agent-analytics-list", {
                        headers: {
                        ...
                        console.error("Delivery agent revenue data fetch failed", err);
                        return { data: null };
                    })
        ...
        <AdminDashboardLayout user={user}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flex: 1, paddingRight: '260px' }}>                   
                    ...
                    <h2 className='heading-admin h2-admin'>DELIVERY AGENT PAYOUTS</h2>
                    ...
                    {(!table || table.length === 0) ? (
                        ...
                        >
                            ...
                            <h2 style={{ marginTop: '1rem' }}>
                                No delivery agent revenue data available for the selected period.
                            </h2>
                            ...
                            <table className="admin-total-table">
                                    ...
                                    <tbody>
                                        ...
                                        {table.map((revenue, index) => (
                                            ...
                                            <tr key={revenue.agentId}>

                                                <td style={{ borderLeft: '1px solid #0EA5E9', borderTop: '1px solid #0EA5E9', borderBottom: '1px solid #0EA5E9' }}>{index + 1}</td> 
                                                <td style={{ borderTop: '1px solid #0EA5E9', borderBottom: '1px solid #0EA5E9' }}>{revenue.agentId}</td>
