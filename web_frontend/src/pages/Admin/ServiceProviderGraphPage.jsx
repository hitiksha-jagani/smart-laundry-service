...
// Description : Service provider report page for admin dashboard.
        ...
        const fetchAllData = async () => {
            ...
            try {
                ...
                const [userRes, graphRes] = await Promise.all([
                    ...
                    axiosInstance.get("/users/service-providers/graphs", {
                        headers: {
                            Authorization: `Bearer ${token}`
                        }
                    }).catch(err => {
                        console.error("Service provider graph data fetch failed", err);
                        return { data: null };
                    }),
                ...
                console.log("Service provider graph data : ", graphRes.data);
        ...
        <AdminDashboardLayout user={user}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flex: 1, paddingRight: '260px', marginBottom: '50px' }}>
                    ...
                    <h2 className="h2-admin">SERVICE PROVIDER TRENDS</h2>
