...
//     try {
//       setLoading(true);
//       const res = await axios.get(`/orders/available-promotions`, {
//         params: { orderId },
//       });
...
//       if (summary.isPromotionApplied && summary.appliedPromoCode === promotions.find(p => p.promotionId === promotionId)?.promoCode) {
//         setAppliedPromoCode(summary.appliedPromoCode);
//         setMessage("✅ This promotion is already applied.");
//       } else if (summary.isPromotionApplied) {
//         setAppliedPromoCode(summary.appliedPromoCode);
//         setMessage(`⚠️ Only one promotion can be applied per order. You have already applied: ${summary.appliedPromoCode}`);
//       } else {
...
//   const isAnyPromoApplied = !!appliedPromoCode;
...
//             const isApplied = appliedPromoCode === promo.promoCode;

//             return (
//               <div
//                 key={promo.promotionId}
//                 className={`border rounded p-4 shadow bg-white transition ${
//                   isApplied ? "border-green-600 bg-green-50" : "hover:shadow-md"
//                 }`}
//               >
...
//                   Valid from{" "}
//                   <strong>{new Date(promo.startDate).toLocaleDateString()}</strong>{" "}
//                   to{" "}
...
//                   disabled={
//                     applyingPromoId === promo.promotionId || isAnyPromoApplied
//                   }
