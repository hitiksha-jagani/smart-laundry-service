...
//    public List<Order> getPendingOrdersForProvider(String serviceProviderId) {
//        return orderRepository.findByServiceProvider_User_UserIdAndStatus(serviceProviderId, OrderStatus.PENDING);
//    }
//
